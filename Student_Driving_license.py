...
def add():
      driving_license_id=5648206713
      print(type(driving_license_id))
      name="Dhyanam B Shah"
      print(type(name))
      dob="24 Decenber, 2011"
      print(type(dob))
      pin_code= 390001
      print(type(pin_code))
      address="Gitanagar Society, beside Vihar Multiplex"
      print(type(address))
      authorisation="Two and Four"
      print(type(authorisation))
      label_id["text"]=driving_license_id
      label_name["text"]=name
      label_dob["text"]=dob
      label_pin["text"]=pin_code
      label_address["text"]=address
      label_vehicle_type["text"]=authorisation
